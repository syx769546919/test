...
<div class="top">
    ...
    <div class="search">
    	<form action="search.do" method="post">
        	<input type="text" name="key" class="s_ipt" />
            <input type="submit" value="搜索" class="s_btn" />
        </form>                      
        <span class="fl"><a href="#">咖啡</a><a href="#">iphone 6S</a><a href="#">新鲜美食</a><a href="#">蛋糕</a><a href="#">日用品</a><a href="#">连衣裙</a></span>
    </div>
    <div class="i_car">
    	<div class="car_t">购物车 [ <span>${carlist.size }</span> ]</div>
        <div class="car_bg">
       		<!--Begin 购物车未登录 Begin-->
            ...
            <div class="price_sum">共计&nbsp; <font color="#ff4e00">￥</font>
            	<span><fmt:formatNumber value="${cartInfo.amount}" pattern="#,##0.00"></fmt:formatNumber></span></div>
